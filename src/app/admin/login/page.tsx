      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#00295c] hover:bg-[#00295c]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00295c]"
            >
              Sign in
            </button>
          </div>
